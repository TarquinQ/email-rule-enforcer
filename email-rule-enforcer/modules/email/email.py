...
def new_email_nonmultipart(from_, to_, subject, bodytext):
    # Create the container (outer) email message.
...
def new_email(from_='', to_='', subject='', bodytext='', files_to_attach=None):
    if files_to_attach is None:
        return new_email_nonmultipart(from_, to_, subject, bodytext)
    else:
        return new_email_multipart(from_, to_, subject, bodytext, files_to_attach)
